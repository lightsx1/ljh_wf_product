...
import cn.weforward.product.Account;
...
public class ProductServiceImpl extends ProductDiImpl implements ProductService {
	...
	public ProductServiceImpl(PersisterFactory factory, CounterFactory counterFactory,BusinessLoggerFactory loggerFactory) {
		super(factory, counterFactory,loggerFactory);
	}
	...
	public Account Login(String id) {
		...
		return m_Account.get(id);
}

	@Override
	public Account Register(String username, String password) {
		// TODO Auto-generated method stub
		return new SimpleAccount(this,username,password);
	}

...
import cn.weforward.product.weforward.view.LogView;
import cn.weforward.product.weforward.view.LogsParams;
...
public class ProductMethods implements ResourceUploader, ResourceDownloader {
	...
	public ResultPage<LogView> logs(LogsParams params) throws ApiException {
		...
		return new TransResultPage<LogView, BusinessLog>(product.getLogs()) {
			@Override
